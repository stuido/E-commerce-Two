...
public class DetailsAdapter extends RecyclerView.Adapter<DetailsAdapter.MyViewHolder> {
    ...
    private List<DetailsData.DatasBean.GoodsCommendListBean> data;

    public DetailsAdapter(Context context, List<DetailsData.DatasBean.GoodsCommendListBean> data) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.detail_listview_item, null);
        //得到WindowManager
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.home_recycler_title.setText(data.get(position).getGoods_name());
        holder.home_recycler_price.setText("¥"+data.get(position).getGoods_promotion_price());
        Picasso.with(context).load(data.get(position).getGoods_image_url()).placeholder(R.mipmap.ic_launcher).into(holder.home_recycler_img);
    }
    //数据长度
    @Override
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            home_recycler_img = (ImageView) itemView.findViewById(R.id.detail_image);
            home_recycler_price = (TextView) itemView.findViewById(R.id.detail_price);
            home_recycler_title = (TextView) itemView.findViewById(R.id.detail_title);
        }
    }
