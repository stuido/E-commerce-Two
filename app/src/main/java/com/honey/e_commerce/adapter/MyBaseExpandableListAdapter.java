...
public class MyBaseExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    OnBuyItemListener onBuyItemListener;
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            childViewHolder.id_iv_logl = (ImageView) convertView
        ...
        Picasso.with(context).load(goodsBean.getImageLogo()).placeholder(R.mipmap.ic_launcher).into(childViewHolder.id_iv_logl);
        ...
        childViewHolder.id_cb_select_child.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                onBuyItemListener.onBuyItemListener(groupPosition,childPosition);
        ...
        childViewHolder.id_tv_goods_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                onDeleteItemListener.onDeleteItemListener(groupPosition,childPosition);
    ...
    public interface OnBuyItemListener{
        void onBuyItemListener(int groupPosition, int childPosition);
    }
    public interface OnDeleteItemListener{
        void onDeleteItemListener(int groupPosition, int childPosition);
    }
