...
public class SearchView extends LinearLayout {
     ...
     * 搜索的按钮
     */
    private ImageView tv_search_search;
    /**
     * 提示的列表
     */
    ...
    private void initView() {
        ...
        tv_search_search = (ImageView) findViewById(R.id.tv_search_search);
    ...
    class SearchOnClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (i == R.id.iv_search_back) {
                ...
                ((Activity) context).overridePendingTransition(R.anim.left_into, R.anim.right_into);
